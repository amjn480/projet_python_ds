...
def main():
    ...
    for language in language_list:
        file = open(
            f"/home/onyxia/work/projet_python_ds/algo_test/article_title_test/list_{language}_test.pickle",
            "rb")
        ...
        for request in requests_list:
            ...
            try:  # error if there is a backslash in the request
                with open(
                    f"/home/onyxia/work/projet_python_ds/algo_test/article_test/{language}/{request}.txt", "w",
